...
import com.fabmo.supervisor.glassedition.Device;
import com.fabmo.supervisor.glassedition.Status;
...
public class GetStatus extends AsyncTask<URL, Integer, Status>{
	...
	@Override
	protected com.fabmo.supervisor.glassedition.Status doInBackground(URL... urls) {
		com.fabmo.supervisor.glassedition.Status return_status = null;
        ...
        for (int i = 0; i < count; i++) {	
			...
			if(current_file != null && current_file.compareTo("null")!=0)
				return_status = new com.fabmo.supervisor.glassedition.Status(state, posx, posy, posz, current_file, nb_lines, line);
			else
				return_status = new com.fabmo.supervisor.glassedition.Status(state, posx, posy, posz);
        }
        return return_status;
	}
	
	@Override
	protected void onPostExecute(com.fabmo.supervisor.glassedition.Status result) {
